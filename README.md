...
**Принцип работы:**
1. Устанавливает длительность импульса (Tp) на максимально допустимое значение (80% времени туда-обратно для целевой дальности D_target).
2. Рассчитывает минимальный VGA Gain, необходимый для достижения целевого SNR при этом максимальном Tp.
...
2. Использует уравнение сонара для точного расчета минимального Tp.
